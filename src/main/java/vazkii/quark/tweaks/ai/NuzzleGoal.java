...
public class NuzzleGoal extends Goal {
	...
	public boolean shouldContinue() {
		if (!WantLoveGoal.needsPets(creature))
			return false;
		return !this.petPathfinder.isIdle() && this.creature.squaredDistanceTo(this.owner) > (this.maxDist * this.maxDist) && !this.creature.isInSittingPose();
	}
	...
	public void tick() {
		...
		if (!this.creature.isInSittingPose()) {
