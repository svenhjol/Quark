...
public class RedstoneInductorBlock extends QuarkBlock implements IBlockColorProvider {
    ...
    public RedstoneInductorBlock(String regname, Module module, ItemGroup creativeTab, Settings properties) {
...
//    }
    ...
    public BlockColorProvider getBlockColor() {
        return (state, world, pos, index) -> index == 1 ? RedstoneWireBlock.getWireColor(state.get(POWER)) : -1; // colorMultiplier
    }
