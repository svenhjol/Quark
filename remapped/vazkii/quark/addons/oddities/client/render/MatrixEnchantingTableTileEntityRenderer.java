...
public class MatrixEnchantingTableTileEntityRenderer extends BlockEntityRenderer<MatrixEnchantingTableTileEntity> {
	...
	public static final SpriteIdentifier TEXTURE_BOOK = new SpriteIdentifier(SpriteAtlasTexture.BLOCK_ATLAS_TEXTURE, new Identifier("entity/enchanting_table_book"));
