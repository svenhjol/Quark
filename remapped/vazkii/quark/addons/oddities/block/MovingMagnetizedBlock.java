...
//	}
	...
	public List<ItemStack> getDroppedStacks(@Nonnull BlockState state, @Nonnull LootContext.Builder builder) {
		MagnetizedBlockTileEntity tile = this.getMagnetTileEntity(builder.getWorld(), builder.get(LootContextParameters.ORIGIN)); // origin
	...
	@Nullable
	private MagnetizedBlockTileEntity getMagnetTileEntity(BlockView world, Vec3d origin) {
