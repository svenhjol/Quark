...
public class HoeHarvestingModule extends QuarkModule {
	...
	private boolean canHarvest(PlayerEntity player, WorldAccess world, BlockPos pos, BlockState state) {
		...
		return (mat == Material.PLANT || mat == Material.NETHER_SHOOTS || mat == Material.REPLACEABLE_PLANT || mat == Material.UNDERWATER_PLANT) && 
				state.canReplace(new ItemPlacementContext(new ItemUsageContext(player, Hand.MAIN_HAND, new BlockHitResult(new Vec3d(0.5, 0.5, 0.5), Direction.DOWN, pos, false))));
	}
