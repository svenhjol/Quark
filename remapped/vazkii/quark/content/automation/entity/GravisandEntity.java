	...
	public void tick() {
		...
		if (this.fallTile.isAir(world, new BlockPos(getPos())) || pos.y > 300 || pos.y < -50) {
			...
			if (!this.world.isClient) {
				...
				if (flag && d0 > 1.0D) {
					BlockHitResult blockraytraceresult = this.world.raycast(new RaycastContext(new Vec3d(this.prevX, this.prevY, this.prevZ), pos, RaycastContext.ShapeType.COLLIDER, RaycastContext.FluidHandling.SOURCE_ONLY, this));
