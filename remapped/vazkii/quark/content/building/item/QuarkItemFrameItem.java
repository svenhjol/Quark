...
public class QuarkItemFrameItem extends QuarkItem {
    ...
    public QuarkItemFrameItem(String name, QuarkModule module, TriFunction<? extends AbstractDecorationEntity, World, BlockPos, Direction> entityProvider, Item.Settings properties) {
