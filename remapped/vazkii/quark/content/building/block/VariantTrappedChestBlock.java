...
public class VariantTrappedChestBlock extends ChestBlock implements IBlockItemProvider, IQuarkBlock, IChestTextureProvider {
	...
	public VariantTrappedChestBlock(String type, QuarkModule module, Supplier<BlockEntityType<? extends ChestBlockEntity>> supplier, Settings props) {
		...
		path = (this instanceof vazkii.quark.content.building.block.VariantTrappedChestBlock.Compat ? "compat/" : "") + type + "/";
	}
	...
	public static class Compat extends VariantTrappedChestBlock {
		...
		public Compat(String type, String mod, QuarkModule module, Supplier<BlockEntityType<? extends ChestBlockEntity>> supplier, Settings props) {
