...
public class RopeBlock extends QuarkBlock implements IBlockItemProvider {
	...
	public RopeBlock(String regname, QuarkModule module, ItemGroup creativeTab, Settings properties) {
	...
	private void moveBlock(World world, BlockPos srcPos, BlockPos dstPos) {
		...
		if(tile != null) {
			tile.setPos(dstPos);
			BlockEntity target = BlockEntity.createFromTag(state, tile.toTag(new CompoundTag()));
			if (target != null) {
