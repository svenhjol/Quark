...
public class CameraModule extends QuarkModule {
	...
	private static final Identifier[] SHADERS = new Identifier[] {
			...
			new Identifier(Quark.MOD_ID, "shaders/post/colorblind/deutranopia.json"),
			new Identifier(Quark.MOD_ID, "shaders/post/colorblind/protanopia.json"),
			new Identifier(Quark.MOD_ID, "shaders/post/colorblind/tritanopia.json"),
			new Identifier(Quark.MOD_ID, "shaders/post/colorblind/achromatopsia.json")
	};
