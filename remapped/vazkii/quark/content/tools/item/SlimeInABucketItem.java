	...
	public ActionResult useOnBlock(ItemUsageContext context) {
		...
		if(!worldIn.isClient) {
			...
			if(data != null)
				...
				slime.getAttributeInstance(EntityAttributes.GENERIC_MAX_HEALTH).setBaseValue(1.0);
				slime.getAttributeInstance(EntityAttributes.GENERIC_MOVEMENT_SPEED).setBaseValue(0.3);
