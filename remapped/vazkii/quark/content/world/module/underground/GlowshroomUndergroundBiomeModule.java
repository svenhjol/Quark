...
import vazkii.quark.content.world.block.GlowceliumBlock;
...
import vazkii.quark.content.world.gen.underground.GlowshroomUndergroundBiome;
...
public class GlowshroomUndergroundBiomeModule extends UndergroundBiomeModule {
	...
	public void construct() {
		...
		VariantHandler.addFlowerPot(glowshroom, "glowshroom", p -> p.luminance(b -> 14));
	...
	public static boolean canSpawnOn(EntityType<? extends MobEntity> typeIn, WorldAccess worldIn, BlockPos pos) {
		...
		return worldIn instanceof World
				...
				&& ((World) worldIn).isSpaceEmpty(EntityType.ZOMBIE.createSimpleBoundingBox(pos.getX() + 0.5, pos.getY(), pos.getZ() + 0.5));
	}
