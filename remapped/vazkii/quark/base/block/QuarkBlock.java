...
public class QuarkBlock extends BasicBlock implements IQuarkBlock {
	...
	public QuarkBlock(String regname, QuarkModule module, ItemGroup creativeTab, Settings properties) {
	...
	public static interface Constructor<T extends Block> {
		...
		public T make(String regname, QuarkModule module, ItemGroup creativeTab, Settings properties);
